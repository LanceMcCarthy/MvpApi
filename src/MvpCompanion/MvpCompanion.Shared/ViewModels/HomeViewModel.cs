...
using MvpCompanion.Shared.Common;
using MvpCompanion.Shared.Dialogs;
using MvpCompanion.Shared.Helpers;
using MvpCompanion.Shared.Views;
using Template10.Common;
using Template10.Mvvm;

namespace MvpCompanion.Shared.ViewModels
{
    public class HomeViewModel : PageViewModelBase
    {
        ...
        private async void ContributionsGrid_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
