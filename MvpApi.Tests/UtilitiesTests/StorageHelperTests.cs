...
namespace MvpApi.Tests.UtilitiesTests
{
    ...
    public class StorageHelperTests
    {
        ...
        {
            // Arrange
            var originalImageBytes = PngTestImage();
        ...
        [TestMethod]
        public void SettingsStorageLifecycle()
        {
            SaveSetting();
            LoadSetting();
        }
        ...
        [TestMethod]
        public void EncryptedTokenStorageLifecycle()
        {
            StoreToken();
            LoadToken();
            DeleteToken();
        ...
        private void StoreToken()
        {
            ...
            var value = "jhdhksjskjmanknknkaknknknaijijsjnjbdugjmljabakmcihoijsoihdjnbdkjbslknsmnsjhjshbslnslkmslknsjhvsb";
